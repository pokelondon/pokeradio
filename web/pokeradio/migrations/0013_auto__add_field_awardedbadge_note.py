...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AwardedBadge.note'
        db.add_column(u'pokeradio_awardedbadge', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AwardedBadge.note'
        db.delete_column(u'pokeradio_awardedbadge', 'note')
