...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'pokeradio_album')

        # Adding field 'Track.artist_href'
        db.add_column(u'pokeradio_track', 'artist_href',
    ...
    def backwards(self, orm):
        # Adding model 'Album'
        db.create_table(u'pokeradio_album', (
            ...
            ('isrc', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'pokeradio', ['Album'])

        # Deleting field 'Track.artist_href'
        db.delete_column(u'pokeradio_track', 'artist_href')
