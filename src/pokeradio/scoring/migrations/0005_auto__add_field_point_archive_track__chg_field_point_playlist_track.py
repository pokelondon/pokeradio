...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Point.archive_track'
        db.add_column(u'scoring_point', 'archive_track',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['history.ArchiveTrack'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Point.playlist_track'
        db.alter_column(u'scoring_point', 'playlist_track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pokeradio.Track'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'Point.archive_track'
        db.delete_column(u'scoring_point', 'archive_track_id')


        # Changing field 'Point.playlist_track'
        db.alter_column(u'scoring_point', 'playlist_track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pokeradio.Track'], null=True))
