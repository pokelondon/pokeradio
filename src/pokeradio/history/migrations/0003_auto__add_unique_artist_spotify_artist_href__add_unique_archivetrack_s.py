...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Artist', fields ['spotify_artist_href']
        db.create_unique(u'history_artist', ['spotify_artist_href'])

        # Adding unique constraint on 'ArchiveTrack', fields ['spotify_href']
        db.create_unique(u'history_archivetrack', ['spotify_href'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArchiveTrack', fields ['spotify_href']
        db.delete_unique(u'history_archivetrack', ['spotify_href'])

        # Removing unique constraint on 'Artist', fields ['spotify_artist_href']
        db.delete_unique(u'history_artist', ['spotify_artist_href'])
