...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArchiveTrack.no_artwork'
        db.add_column(u'history_archivetrack', 'no_artwork',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArchiveTrack.no_artwork'
        db.delete_column(u'history_archivetrack', 'no_artwork')
