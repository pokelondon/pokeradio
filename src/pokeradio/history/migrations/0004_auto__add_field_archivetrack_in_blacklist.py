...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArchiveTrack.in_blacklist'
        db.add_column(u'history_archivetrack', 'in_blacklist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArchiveTrack.in_blacklist'
        db.delete_column(u'history_archivetrack', 'in_blacklist')
